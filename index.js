...
function removeFlavorByName(arr, remove){
...
function filterByWord(arr,fesFlav,highlight){
    highlight = [];
    for (i = 0; i< arr.length; i++){
        if(arr[i].includes(fesFlav)){
        highlight.push(arr[i]);
    }
}
return highlight;
}
console.log(filterByWord(originalFlavors, "Chocolate", "Chocolate Flavors"));
